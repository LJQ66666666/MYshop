						...
						<form id="form_search">
							<div class="form-row align-items-center">
								<div class="col-auto my-1">
									<select class="form-control" name="userKind">
								...
								<div class="col-auto my-1">
									<input type="text" class="form-control" name="userMobile" placeholder="用户手机">
								</div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">是否锁定</label>
						<div class="col-sm-7">
							<select class="form-control validate[required]" name="userLock" id="userLock">
								<option value="0">未锁定</option>
								<option value="1">锁定</option>
							</select>
						</div>
...
<script src="assert/page/myshop-user.js"></script>