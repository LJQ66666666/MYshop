		...
		<div class="main center">
			<div class="mingxing fl mb20" style="border: 2px solid #fff; width: 230px; cursor: pointer;" onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
				<div class="sub_mingxing">
					<a href="xiangqing"><img src="image/liebiao_xiaomi6.jpg" alt=""></a>
				</div>
				<div class="pinpai">
					<a href="xiangqing">小米6</a>
				</div>
			...
			<div class="mingxing fl mb20" style="border: 2px solid #fff; width: 230px; cursor: pointer;" onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
				<div class="sub_mingxing">
					<a href="xiangqing"><img src="image/liebiao_xiaomi5c.jpg" alt=""></a>
				</div>
				<div class="pinpai">
					<a href="xiangqing">小米手机5c</a>
				</div>
			...
			<div class="mingxing fl mb20" style="border: 2px solid #fff; width: 230px; cursor: pointer;" onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
				<div class="sub_mingxing">
					<a href="xiangqing"><img src="image/liebiao_xiaomimix.jpg" alt=""></a>
				</div>
				<div class="pinpai">
					<a href="xiangqing">小米MIX</a>
				</div>
			...
			<div class="mingxing fl mb20" style="border: 2px solid #fff; width: 230px; cursor: pointer;" onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
				<div class="sub_mingxing">
					<a href="xiangqing"><img src="image/liebiao_xiaomi5s.jpg" alt=""></a>
				</div>
				<div class="pinpai">
					<a href="xiangqing">小米5s</a>
				</div>
			...
			<c:if test="${!empty goodsList}">
				<c:forEach items="${goodsList}" var="goods">
					<div class="mingxing fl mb20" style="border: 2px solid #fff; width: 230px; cursor: pointer;" onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
						...
						<div class="pinpai">
							<a href="">${goods.goodsName}</a>&nbsp;&nbsp; 库存数量<a>${goods.goodsNum}</a>
						</div>
						<!-- <div class="youhui">多彩金属 / 4100mAh 超长续航</div> -->
						<div class="jiage">￥${goods.goodsPrice}</div>
						<p>
							<a href="javascript:goAddCart(${commodity.rowId});">加入购物车</a>
						</p>
					</div>
				</c:forEach>
			</c:if>
